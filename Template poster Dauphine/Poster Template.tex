...
\raggedright
\includegraphics[width=10cm,valign=t]{DDD.png}
\end{minipage}
%
\begin{minipage}[b]{0.33\linewidth}
\centering
\includegraphics[width=25cm,valign=t]{logo_dauphine_psl.png}
\end{minipage}
% 
\begin{minipage}[b]{0.33\linewidth}
\raggedleft
\includegraphics[width=5cm,valign=t]{chaire_gouvernance_et_rgulation_logo.jpeg}
\end{minipage}\\
